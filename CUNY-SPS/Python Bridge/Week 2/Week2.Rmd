...
print('\n= ({0} - {1})({2} - {3}) - {4} = 0'.format(AxI[0][0], lamda[0][0], AxI[1][1], lamda[1][1], AxI[1][0] * AxI[0][1]))
...
print("\n= {0}{1}{2}+{3} = 0".format(coeff, -AxI[0][0]-AxI[1][1], lamda[1][1], ((-AxI[0][0])*(-AxI[1][1]))-((-AxI[1][0]) * (-AxI[0][1]))))  
...
print('\n= ({0} - {1})({2} - {3}) - ({4})({5})=0'.format(ATA[0][0], lamda[0][0], ATA[1][1], lamda[1][1], ATA[1][0], ATA[0][1]))
print('\n= ({0} - {1})({2} - {3}) - {4} = 0'.format(ATA[0][0], lamda[0][0], ATA[1][1], lamda[1][1], ATA[1][0] * ATA[0][1]))
...
print("\n= {0}{1}{2}+{3} - {4} = 0".format(coeff, -ATA[0][0]-ATA[1][1], lamda[1][1], (-ATA[0][0])*(-ATA[1][1]), (-ATA[1][0]) * (-ATA[0][1])))        


print("\n= {0}{1}{2}+{3} = 0".format(coeff, -ATA[0][0]-ATA[1][1], lamda[1][1], ((-ATA[0][0])*(-ATA[1][1]))-((-ATA[1][0]) * (-ATA[0][1]))))  
